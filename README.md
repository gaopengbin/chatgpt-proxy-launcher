...
一个轻量的 Windows 小工具：检查本地 HTTP 代理，并在仅影响当前应用的环境变量中启动 ChatGPT/Codex Desktop。单文件约 13 KB，无需管理员权限。
...
输出为 `output/ChatGPTProxyLauncher.exe`，当前约 13 KB。构建使用 Windows 自带的 .NET Framework C# 编译器。
